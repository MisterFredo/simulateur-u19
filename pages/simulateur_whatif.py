...
# --- Data editor simplifié : suppression des ID techniques
...
if st.button("🔁 Recalculer le classement avec ces scores simulés"):
    ...
    if df_valid.empty:
        ...
        for idx, row in df_valid.iterrows():
            id_match = matchs_simulables.iloc[idx]["ID_MATCH"]  # récupérer l'ID_MATCH d'origine
        ...
        # --- Sécuriser : ne garder que les matchs complets
